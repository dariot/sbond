...
contract SmartBond is Ownable {
    ...
    uint256 frequency;
    uint256 cedoleToPay; // numero di cedole da pagare
    uint256 cedolaValue; 
    ...
    */
    constructor (address payable _beneficiarioAddress, uint256 _frequency, uint256 _interestTotalValue) public {
    ...
    */
    ...
    function calcCedolaValue(uint256 _frequency, uint256 _interestValue) private returns(uint256) {
